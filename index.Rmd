...
* create a uniform access to the data across publications
...
In this slides I use this virsion:
```{r}
...
---
## Glottolog functions
Functions structure: **what you need - what you have**
...
It is possible to use output of one function as an input for an other:
```{r}
...
---
## Color languages by the categorical variable
```{r}
...
---
## Color languages by the numeric variable
```{r}
map.feature(ejective_and_n_consonants$language,
...
---
## Add density estimation without dots
```{r}
map.feature(circassian$language, features = circassian$dialect,
            latitude = circassian$latitude, 
            longitude = circassian$longitude,
...
.pull-right[
* I recieved some comments and suggestion from
